...
class EquipmentMarkerGizmoGroup(GizmoGroup):
    ...
    def draw_prepare(self, context):
        ...
        current_count = sum(len(items) for items in river_equipment_placement.PLACED_EQUIPMENT.values())
    ...
    def refresh_gizmos(self):
        ...
        for equipment_type, items in river_equipment_placement.PLACED_EQUIPMENT.items():
            for item in items:
